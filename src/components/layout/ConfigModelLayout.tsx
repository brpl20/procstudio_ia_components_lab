                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="relative">
                      <select
                        id="tipo-contrato"
                        className="w-full h-10 px-3 py-2 bg-white border border-[#999999] rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
